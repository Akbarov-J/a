...
javascript: (function () {
  ...
  try {
    ...
    showMessageForYuborildi("Yuborildi ✅");
  } catch (err) {
    console.error(err);
    alert("Xato ❌");
  }
  ...
  function makeBoxYuborildi() {
    if (boxYuborildi) return boxYuborildi;

    boxYuborildi = document.createElement("div");

    Object.assign(boxYuborildi.style, {
      position: "fixed",
      right: "10px",
      bottom: "10px",
      color: "#111",
    ...
    document.body.appendChild(boxYuborildi);
  ...
  function showMessageForYuborildi(msg) {
    const b = makeBoxYuborildi();
